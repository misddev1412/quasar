  ...
  for (const router of routers) {
    ...
    for (const procedure of router.procedures) {
      ...
      const hasInput = procedure.type === 'mutation' ||
                      ['list', 'detail', 'getById', 'getByIdWithTranslations', 'getCategoryTranslations', 'getBrandTranslations', 'getAttributeTranslations', 'getByCustomerId', 'getByCustomerIdAndType', 'getByPath', 'getProducts', 'getProductById', 'getProductBySlug', 'getProductsByCategory', 'getAdministrativeDivisions', 'getAdministrativeDivisionsByParentId', 'getAddressById'].includes(procedure.name);
