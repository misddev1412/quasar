    ...
    >
      ...
      <ContactPriceModal
        ...
        labels={{
          ...
          requiredError: t('validation.required', 'This field is required'),
          nameRequiredError: t('validation.required', 'This field is required'),
          phoneRequiredError: t('validation.required', 'This field is required'),
          emailRequiredError: t('validation.required', 'This field is required'),
          invalidEmailError: t('validation.email', 'Please enter a valid email address'),
          invalidPhoneError: t('validation.invalid_phone_by_country', 'Please enter a valid phone number for the selected country'),
