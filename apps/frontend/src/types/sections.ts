...
import { HeroSliderConfig, FeaturedProductsConfig, ProductsByCategoryConfig, NewsSectionConfig, CustomHtmlConfig, SectionTranslationContent } from '../components/sections';
