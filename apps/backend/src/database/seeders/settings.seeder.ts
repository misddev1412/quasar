...
export class SettingsSeeder {
  ...
  async seed(): Promise<void> {
    ...
    const defaultSettings = [
      ...
      {
        key: 'storefront.loading_overlay_title',
        value: '',
        type: 'string' as const,
        group: 'storefront',
        isPublic: true,
        description: 'Custom storefront loading overlay title',
      },
      {
        key: 'storefront.loading_overlay_message',
        value: '',
        type: 'string' as const,
        group: 'storefront',
        isPublic: true,
        description: 'Custom storefront loading overlay message',
      },
      {
        key: 'storefront.loading_overlay_show_logo',
        value: 'true',
        type: 'boolean' as const,
        group: 'storefront',
        isPublic: true,
        description: 'Show site logo on storefront loading overlay',
      },
      {
        key: 'storefront.loading_overlay_background_color',
        value: '',
        type: 'string' as const,
        group: 'storefront',
        isPublic: true,
        description: 'Storefront loading overlay background color',
      },
      {
        key: 'storefront.loading_overlay_accent_color',
        value: '#3b82f6',
        type: 'string' as const,
        group: 'storefront',
        isPublic: true,
        description: 'Storefront loading overlay accent color',
      },
      {
        ...
        group: 'storefront',
        isPublic: false,
        description: 'Enable maintenance mode for the storefront',
      },
      {
        key: 'storefront.maintenance_password',
        value: '',
        type: 'string' as const,
        group: 'storefront',
        isPublic: false,
        description: 'Password required to bypass storefront maintenance mode',
      },
      {
        key: 'storefront.maintenance_message',
        value: 'We are performing scheduled maintenance. Please check back soon.',
        type: 'string' as const,
        group: 'storefront',
        isPublic: true,
        description: 'Displayed message while the storefront is under maintenance',
      },
      {
        key: 'admin.theme',
        value: 'light',
