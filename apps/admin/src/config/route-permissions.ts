...
export const ROUTE_PERMISSIONS: Record<string, RoutePermission> = {
  ...
  // Purchase Orders
  '/purchase-orders': { resource: 'purchase_order', action: PermissionAction.READ, scope: PermissionScope.ANY },
  '/purchase-orders/create': { resource: 'purchase_order', action: PermissionAction.CREATE, scope: PermissionScope.ANY },
  '/purchase-orders/:id': { resource: 'purchase_order', action: PermissionAction.READ, scope: PermissionScope.ANY },
  '/purchase-orders/:id/edit': { resource: 'purchase_order', action: PermissionAction.UPDATE, scope: PermissionScope.ANY },
};
