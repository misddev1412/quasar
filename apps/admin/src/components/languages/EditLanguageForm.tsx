...
export const EditLanguageForm: React.FC<EditLanguageFormProps> = ({
          ...
          fields: [
            {
              ...
              disabled: language.isDefault, // Can't change code of default language
            },
            {
              name: 'name',
          ...
          fields: [
            {
              ...
              disabled: language.isDefault, // Can't deactivate default language
            },
            {
              name: 'isDefault',
  ...
  // Initial values from existing language data
  const initialValues: Partial<UpdateLanguageFormData> = {
    code: language.code,
    name: language.name,
  ...
  return (
    <EntityForm<UpdateLanguageFormData>
      tabs={tabs}
