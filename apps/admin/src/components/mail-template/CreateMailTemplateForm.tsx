...
import { MailTemplateFormData, MAIL_TEMPLATE_TYPE_OPTIONS } from '@admin/types/mail-template';
import { useTranslationWithBackend } from '@admin/hooks/useTranslationWithBackend';
import { useEmailChannels } from '@admin/hooks/useEmailChannels';
import { z } from 'zod';

interface CreateMailTemplateFormProps {
...
const createMailTemplateSchema: z.ZodType<MailTemplateFormData> = z.object({
...
export const CreateMailTemplateForm: React.FC<CreateMailTemplateFormProps> = ({
  onSubmit,
  onCancel,
  isSubmitting = false,
  showActions = true,
          ...
          fields: [
            {
              ...
              type: 'textarea',
              placeholder: t('mail_templates.preview_note_placeholder', 'Template preview will be available after creation'),
              required: false,
              rows: 2,
              disabled: true,
              description: t('mail_templates.preview_note_description', 'You can preview the template after creating it'),
            },
          ],
        },
      ],
  ...
  const defaultValues: Partial<MailTemplateFormData> = {
    isActive: true,
    variables: '',
